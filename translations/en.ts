export default {
  ...
  florilegium : {
    caption: "florilegium is the literary term for a collection of excerpts from poetry or prose",
  ...
  again : {
    caption: "exploration of symbolic drawings and their connection to the body",
    model: "model",
    helen: "helen cheng",
  },
  maybe : {
