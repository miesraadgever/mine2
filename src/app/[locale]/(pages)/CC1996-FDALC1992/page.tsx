  ...
  return (
    <div className={`flex ${smallScreen ? "flex-col" : "flex-row"} col-12 `}>
      <div className={`flex flex-col ${smallScreen ? "col-12" : "col-6"}`}>
        ...
        {/* Images */}
        <div
          className={`flex-wrap flex gap-3 ${smallScreen ? " justify-center" : "ml-6 justify-center"}`}
        >
          <div className="">
            <CldImage
              src={
                "https://res.cloudinary.com/dwgsproch/image/upload/v1710074528/12%20MI_NE%202021%201%20-%20CC%201996%20FDALC%201992/FDALC1992.png"
              }
              alt={"ma-1"}
              width={400}
              height={500}
