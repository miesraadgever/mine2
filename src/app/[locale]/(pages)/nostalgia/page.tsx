      ...
      <div className={`flex flex-col ${smallScreen ? "col-12" : "col-6"}`}>
        ...
        >
          ...
          <div className="">
            <CldImage
              src={
                "https://res.cloudinary.com/dwgsproch/image/upload/v1710077602/14%20MI_NE%202021%201%20-%20nostalgia%20ultra%20%5Bshoot%5D/_MG_9115-min_d2j58d.jpg"
              }
              alt={"foto2"}
              width={300}
              height={400}
          ...
          <div className="">
            <CldImage
              src={
                "https://res.cloudinary.com/dwgsproch/image/upload/v1709931676/14%20MI_NE%202021%201%20-%20nostalgia%20ultra%20%5Bshoot%5D/2021-01-09_17.33.33_tkmxjc.jpg"
              }
              alt={"foto3"}
              width={600}
              height={600}
          ...
          <div className="">
            <CldImage
              src={
                "https://res.cloudinary.com/dwgsproch/image/upload/v1710078164/14%20MI_NE%202021%201%20-%20nostalgia%20ultra%20%5Bshoot%5D/_MG_9163-min-min-min_q1zgsp.jpg"
              }
              alt={"foto3"}
              width={600}
              height={600}
