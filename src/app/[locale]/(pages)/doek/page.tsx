      ...
      <div className={`flex flex-col ${smallScreen ? "col-12" : "col-6"}`}>
        ...
        <div className={`${smallScreen ? "ml-2 mb-4" : "p-6 mb-4"} `}>
          ...
          <p className="mt-3">
            ...
            {t("general.credits")}{" "}
            <i>
              {t("general.mies")} & {t("general.neeltje")}
            </i>
            <br />
        ...
        >
          ...
          <div className="">
            <CldImage
              src={
                "https://res.cloudinary.com/dwgsproch/image/upload/v1709930412/17%20MI_NE%202021%203%20-%20doek/2021-03-31_13.34.38_zsgtaj.jpg"
              }
              alt={"foto2"}
              width={300}
              height={400}
          ...
          <div className="">
            <CldImage
              src={
                "https://res.cloudinary.com/dwgsproch/image/upload/v1709930415/17%20MI_NE%202021%203%20-%20doek/WhatsApp_Image_2022-02-28_at_14.33.34_3_zkt16n.jpg"
              }
              alt={"foto3"}
              width={600}
              height={600}
          ...
          <div className="">
            <CldImage
              src={
                "https://res.cloudinary.com/dwgsproch/image/upload/v1709930409/17%20MI_NE%202021%203%20-%20doek/WhatsApp_Image_2022-02-28_at_14.28.55_btlsma.jpg"
              }
              alt={"foto3"}
              width={600}
              height={600}
