           ...
           <div className={`flex flex-col ${smallScreen ? "col-12" : "col-6"}`}>
               ...
               {smallScreen && (
                   <div className={"col-12 justify-center flex "}>
                       <div className="flex ">
                           <Image
                               src={"https://res.cloudinary.com/dwgsproch/image/upload/v1712518767/NEELTJE%20-%20spiegeltjes/image00099_q7okeo.jpg"}
                               alt={"spiegel"}
                               width={645}
                               height={750}
                           />
                       ...
                       <div className={`flex-wrap flex gap-3 mt-10 ${smallScreen ? " justify-center" : "ml-6 justify-start"}`}>
                              <CldImage
                                   src={"https://res.cloudinary.com/dwgsproch/image/upload/v1712326699/NEELTJE%20-%20spiegeltjes/img20240330_17373983_zvn8ik.jpg"}
                                   alt={"spiegel1"}
                                   width={300}
                                   height={400}
                               ...
                               />
                               <CldImage
                                   src={"https://res.cloudinary.com/dwgsproch/image/upload/v1712524218/NEELTJE%20-%20spiegeltjes/img20240330_17365177_atwpbi.jpg"}
                                   alt={"spiegel2"}
                                   width={300}
                                   height={400}
                                   className="w-72 h-84 object-cover"
