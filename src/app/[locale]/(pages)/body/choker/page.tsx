        ...
        <div className={`flex flex-col ${smallScreen ? "col-12" : "col-6"}`}>
          ...
          {smallScreen && (
              <div className={"col-12 justify-center flex"}>
                <div className="flex ">
                <Image
                      src={"https://res.cloudinary.com/dwgsproch/image/upload/v1712753665/neeltje%20-%20sgw:%20choker/Foto_07-04-2024_09_10_041_rjo6if.jpg"}
                      alt={"choker1"}
                      width={600}
                      height={700}
                  />
          ...
          <CldImage
                  src={"https://res.cloudinary.com/dwgsproch/image/upload/v1712519774/neeltje%20-%20sgw:%20choker/img20240407_14174907_fqalxh.jpg"}
                  alt={"choker2"}
                  width={300}
                  height={400}
              ...
              />
              <CldImage
                  src={"https://res.cloudinary.com/dwgsproch/image/upload/v1712523632/neeltje%20-%20sgw:%20choker/Foto_07-04-2024_09_11_23_hwztqo.jpg"}
                  alt={"choker3"}
                  width={300}
                  height={400}
                  className="w-72 h-86 object-cover"
