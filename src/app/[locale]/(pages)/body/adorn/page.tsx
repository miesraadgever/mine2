  ...
  return (
      <div className={`flex ${smallScreen ? "flex-col" : "flex-row"} col-12 `}>
        <div className={`flex flex-col ${smallScreen ? "col-12" : "col-6"}`}>
          ...
          {smallScreen && (
              <div className={"col-12 justify-center flex"}>
                ...
                <video className={""} width="600" height="700" loop muted autoPlay>
                    <source
                      src={"https://res.cloudinary.com/dwgsproch/video/upload/v1712752778/neeltje%20-%20sgw:%20adorn/IMG_9723_-_1_xsa36n.mp4" }
                    ></source>
                  </video>
                </div>
              </div>
          ...
          <CldImage
                  src={"https://res.cloudinary.com/dwgsproch/image/upload/v1712752486/neeltje%20-%20sgw:%20adorn/2020-04-19_16.17.47-1_ga54r4_dhzswk.jpg"}
                  alt={"adorn1"}
                  width={300}
                  height={400}
              ...
              />
              <CldImage
                  src={"https://res.cloudinary.com/dwgsproch/image/upload/v1712752383/neeltje%20-%20sgw:%20adorn/WhatsApp_Image_2022-02-01_at_17.31.57_d3qmuy.jpg"}
                  alt={"adorn1"}
                  width={300}
                  height={400}
                  className="w-72 h-86 object-cover"
