    ...
    <>
      <div className="flex flex-row gap-10 col-12">
        <div className="flex col-5 pl-5 ">
          ...
          kleding. Vanuit hier ontstond mi_ne movement; een interdisciplinair
          collectief.
          <br />
          <br />
          Binnen mi_ne movement onderzoeken mies en neeltje oa. thema’s als
          dualiteit, femine rage en lichamelijke expressie. Deze thema’s worden
          zowel mysthiek als confronterend tot vorm gebracht in projecten
          variërend van audiovisueel werk tot schilderijen, tot teksten en terug
          naar kleding. <br /> <br />
      ...
      <div className="flex flex-row gap-10 col-12">
        <div className="flex col-5 flex-column">
          <p className="font-medium text-4xl mb-3 mt-10 pl-7">
            {" "}
            /MI / - Mies Raadgever{" "}
          </p>
          <p className="pl-7 ">
            Mies werkt als beeldend kunstenaar en ontwerper. <br />
            <br />
            ’Opgeleid als grafisch ontwerper begon ik met het abstract
            verbeelden van concepten. Langzamerhand is mijn praktijk meer
            ge-shift naar werk wat de scheidingslijn en grenzen tussen digitaal
            en analoog werk ontdekt. <br />
            <br />
            Door analoog werk te vermengen met de mogelijkheden van digitale
            media, vertel ik mijn verhaal in een eigen handschrift. Mijn werk is
            figuratief maar de boodschap kan abstract zijn. Hierdoor laat ik
            veel ruimte over voor eigen interpretatie. De toeschouwer kan ieder
            een andere en persoonlijke boodschap uit het werk halen. <br />
            <br />
            Ik werk graag samen of in opdracht van anderen. Samen creëren is
            voor mij belangrijk. Door meerdere disciplines en visies samen te
            brengen komt er een werk uit wat op meerdere facetten interessant
            kan zijn.’{" "}
          </p>
        </div>
        <div className="flex col-5 flex-column">
          ...
          <p className="pl-7">
            ...
            <br />
            <br />
            ‘Mijn werk gaat veel over beweging. Beweging van lichamen, beweging
            in ritueel, beweging door verhaal. Ik leer diep door lichaam in
            ...
            onsamenhangende, het amorfe, het rauwe, het trieste en het kleine.’
          </p>
        </div>
      </div>
        ...
        <div className="flex col-6 flex-column">
          <div className="text-sm pl-7">
            ...
            <p className="leading-6">
              ...
              <br />
              Videoperformance ‘Kroning van een weesmeisje’ voor collectief
              Painted Series te Amsterdam, 2022
              <br />
              Performance ‘ChildhoodStories’ voor Maria Vogt te Café Bosh
              Arnhem, 2021 <br />
