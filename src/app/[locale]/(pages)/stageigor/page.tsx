        ...
        <div className={`flex ${smallScreen ? "flex-col" : "flex-row"} col-12 `}>
            <div className={`flex flex-col ${smallScreen ? "col-12" : "col-6"}`}>
                ...
                <div className={`flex-wrap flex gap-2 mt-10 ${smallScreen ? " justify-center" : "ml-6 justify-start"}`}>
                    ...
                    <div className="">
                        <CldImage
                            src={"https://res.cloudinary.com/dwgsproch/image/upload/v1712235032/MIES%20-%20stagedesign/4_qmwr1n.jpg"}
                            alt={"foto2"}
                            width={300}
                            height={400}
                            className={"object-cover w-80 h-96"}
                    ...
                    <div className="">
                        <CldImage
                            src={"https://res.cloudinary.com/dwgsproch/image/upload/v1712235059/MIES%20-%20stagedesign/3_vjj6rh.jpg"}
                            alt={"foto3"}
                            width={600}
                            height={600}
                            className={"object-cover w-80 h-96"}
